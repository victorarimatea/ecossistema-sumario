...
| S04 | skl-github-orquestracao | v2.2 | Garante consistência do ecossistema a cada operação — plano, aprovação, execução, verificação |
...
| W03 | wkf-registro-sessao | v1.1 | ativo | Registro estruturado de sessões de trabalho intensivo — preserva história da construção do ecossistema |
