...
- Correção do cabeçalho de versão no `taxonomia.md` (conformidade com padrão)
- Versão do `nomenclatura.md` atualizada para v0.2 — 2026-05-26
...
### Repositórios registrados nesta versão
- M01 — ecossistema-sumario (este repositório)
